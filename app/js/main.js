$(function(){
  ...
  // HEADER
  $('.menu__btn').on('click', function(){ // после клика добавляется класс
    $('.menu__list').toggleClass('menu__list--active');
  });

  //FOOTER
  $('.footer-top__title').on('click', function () { 
    $(this).next().slideToggle(); //работает для каждого по отдельности
    $(this).toggleClass('footer-top__title--active'); //добавляет новый класс, который стилизуем
  });
